...
public class DolceBot extends ListenerAdapter {
	...
	private DolceBot() {
		...
		JDABuilder builder = JDABuilder.createDefault(Config.get("TOKEN"),intents);
	    builder.disableCache(CacheFlag.MEMBER_OVERRIDES);
	    builder.setBulkDeleteSplittingEnabled(false);
	    builder.setCompression(Compression.NONE);
	    builder.setActivity(Activity.listening("/play <link>"));
		builder.addEventListeners(new DolceBot());		
		builder.build();    
	}
